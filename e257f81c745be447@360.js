...
function _1(md){return(
  md`# Model Deployment Options
  
  Click a black node to expand or collapse [the tree](https://observablehq.com/@d3/collapsible-tree@360).`
  )}
...
function _chart(d3,data,dy,margin,width,dx,tree,diagonal)
{
  ...
  root.descendants().forEach((d, i) => {
    ...
    if (d.depth && d.data.name.length !== 100) d.children = null;
  });
...
{top: 10, right: -1000, bottom: 10, left: 150}
)}
